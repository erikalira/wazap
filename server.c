...
#define DESCONECT_CALL_STRING "#sair"
...
void conversa_client(){
    ...
    }while(strcmp(message, DESCONECT_CALL_STRING)); // sai quando receber um "#sair" do cliente

    printf("encerrando conversa com o client\n");
}
